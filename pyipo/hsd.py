...
from ldlt import ldltfac, forwardbackward

EPS = 1.0e-12
MAX_ITER = 200


def solver(m, n, nz, iA, kA, A, b, c, f):
...
if __name__ == "__main__":
    ...
    c = np.array([2,3,4])     # coefficients of variables in objective function.
    ...
    status, x, y = solver(m, n, nz, iA, kA, A, b, c, f)
    print(status, x, y)
